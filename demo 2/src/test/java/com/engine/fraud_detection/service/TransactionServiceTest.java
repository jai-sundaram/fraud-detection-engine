...
public class TransactionServiceTest {
    ...
    void testStoreTransaction() throws JOpenCageException{
        ...
        List<Transaction> userTransaction1 = new ArrayList<>();
        ...
        when(engine.geoVelocityCheck(any(Transaction.class), any(List.class)))
        .thenReturn(10.0);
        when(engine.merchantCheck(any(Transaction.class), any(List.class)))
        .thenReturn(15.0);
        when(engine.velocityCheck(any(Transaction.class), any(List.class)))
        .thenReturn(0.0);
        ...
        when(engine.timeCheck(any(Transaction.class)))
        .thenReturn(5.00);
        when(engine.amountAnomalyCheck(any(Transaction.class), any(List.class)))
        .thenReturn(10.00);
